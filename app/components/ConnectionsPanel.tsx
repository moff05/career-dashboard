...
export function ConnectionsPanel() {
  ...
  return (
    <>
      ...
      <div className="overlay-panel from-bottom" style={{ left: '50%', top: '50%', transform: 'translate(-50%, -50%)', width: 'min(640px, 94vw)', maxHeight: '88vh', borderRadius: 'var(--r-lg)', display: 'flex', flexDirection: 'column' }}>
