    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '640px' }}>
        ...
        <p style={{ textAlign: 'center', color: 'var(--text-dim)', fontSize: '11px', marginTop: '20px' }}>
          <a href="https://github.com/moff05/career-dashboard" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'underline' }}>Open source</a> · No account required · <Link href="/extension" style={{ color: 'inherit', textDecoration: 'underline' }}>Chrome extension</Link> · <Link href="/privacy" style={{ color: 'inherit', textDecoration: 'underline' }}>Privacy</Link>
        </p>
      </div>
    </div>
  );
